...
class ParseCache:
    ...
    def get(self, key: str, signature: list, compute, encode=None, decode=None,
        ...
        ``keep`` decides whether a freshly computed value is worth storing: caching an incomplete
        parse under an unchanged signature would make every later run reuse it.
        """
