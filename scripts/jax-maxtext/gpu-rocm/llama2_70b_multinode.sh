...
dataset_type: "hf"
tokenizer_path: "/home/amd/data/Llama-2-7b-hf/"' > $OUTPUT_DIR/llama2_70b_gpu.yml
...
srun --nodes=$SLURM_JOB_NUM_NODES --ntasks=$SLURM_JOB_NUM_NODES \
	...
	cp '${OUTPUT_DIR}'/llama2_70b_gpu.yml MaxText/configs/llama2_70b_gpu.yml
	source install_packages.sh
        source maxtext_env_70b.sh	
        python MaxText/train.py MaxText/configs/llama2_70b_gpu.yml base_output_directory=output 2>&1 |& tee -a llama2_70b.real.log
    "'
