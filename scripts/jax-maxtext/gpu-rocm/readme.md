...
HF_HOME is where huggingface_hub will store local data, please refer to [Huggingface cli Document](https://huggingface.co/docs/huggingface_hub/main/en/guides/cli#hf-download) on how to download the data.
...
```
hf login --token=hf_xxxx
hf download meta-llama/Llama-2-7b  --include "**token**" 
hf download meta-llama/Llama-2-70b  --include "**token**" 
hf download meta-llama/Meta-Llama-3-8B  --include "**token**" 
hf download meta-llama/Meta-Llama-3-70B  --include "**token**" 
```
## Dataset download
