...
| `GLM-5.1-FP8` | MoE + DSA | 3 (moriio wideEP only) | own image (`glmv5.1` Dockerfile); 1P/1D EP8 + 2P/2D EP16 validated; EP32 fixed but not re-validated on the current pins |
