...
#
# In the InferenceX CI this installs/patches runtime deps into the container. Our image
# (rocm/atom-dev:nightly_202606101403) already ships everything needed for DSv4 disagg —
# verified present: atomesh (/usr/local/bin/atomesh), mooncake (py3.12 site-packages +
