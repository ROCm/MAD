...
# Selected via BENCHMARK_SCRIPT=agentic.
# BENCHMARK_SCRIPT=agentic auto-enables server metrics (gpu_cache_hit_rate) + radix prefix cache.
#
# DeepSeek-V3 1P/1D (canonical, DP_MODE=1 wideEP):
#export DOCKER_IMAGE_NAME=<mori-sglang-image>
#export BENCHMARK_SCRIPT=agentic RUN_MORI=1 DP_MODE=1 xP=1 yD=1 MODEL_NAME=DeepSeek-V3
