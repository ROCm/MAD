...
rows=[
 ("Input ISL P50",  p(ai,.5), 74000,  0.80,1.20),
 ("Input ISL P90",  p(ai,.9), 155000, 0.80,1.20),
 ("Input ISL P99",  p(ai,.99),235000, 0.80,1.20),
 ("Output OSL P50", p(oa,.5), 320,    0.70,1.40),
 ("Output OSL P90", p(oa,.9), 3300,   0.70,1.40),
 ("Output OSL P99", p(oa,.99),17000,  0.70,1.40),
 ("Turns P50",      p(tu,.5), 3,      0.60,1.60),
 ("Turns P90",      p(tu,.9), 20,     0.60,1.60),
 ("Turns P99",      p(tu,.99),103,    0.60,1.60),
 ("Delay P50 (s)",  p(dl,.5), 4,      0.50,2.00),
 ("Delay P90 (s)",  p(dl,.9), 31,     0.50,2.00),
