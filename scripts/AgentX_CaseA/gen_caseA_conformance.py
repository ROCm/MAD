...
ISL_mu, ISL_sig   = lognorm_from_p(74000, 155000, 235000)
OSL_mu, OSL_sig   = lognorm_from_p(320, 3300, 17000)
DLY_mu, DLY_sig   = lognorm_from_p(4, 31, 240)
...
def sample_turns():
    ...
    return rng.choices([1,2,3,4,6,10,20,45,103],
                       weights=[22,24,20,12,6,5,6,3,2])[0]
...
def make_session(idx):
    ...
    for turn in range(n_turns):
        isl = samp(ISL_mu, ISL_sig, 1200, 245000)     # this turn's input tokens
